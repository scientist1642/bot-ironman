...
parser.add_argument('--driver', choices=['orig','ironman', 'origx', 'key', 'wheel', 'ff', 'random', 'dqn', 'linear', 'demo', 'ac', 'alinear', 'record', 'player'], default='linear')
...
elif arguments.driver == 'origx':
    from origdriverx import Driver
    driver = Driver(arguments.stage)
elif arguments.driver == 'ironman':
    from ironmandriver import Driver
